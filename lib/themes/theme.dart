...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      textTheme: const TextTheme(bodyLarge: TextStyle(color: LightColor.black,fontFamily: 'Mulish')),
      iconTheme: const IconThemeData(color: LightColor.iconColor),
      dividerColor: LightColor.lightGrey,
      primaryTextTheme: const TextTheme(bodyLarge: TextStyle(color: LightColor.titleTextColor)),
